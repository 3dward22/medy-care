    ...
    <?php $__currentLoopData = $pendingUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td class="text-center">
                ...
                <form method="POST"
                      action="<?php echo e(route('admin.users.approve', $user)); ?>"
                      class="d-inline">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
                ...
                <form method="POST"
                      action="<?php echo e(route('admin.users.reject', $user)); ?>"
                      class="d-inline"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\medcare-system\resources\views/admin/users/verify.blade.php ENDPATH**/ ?>